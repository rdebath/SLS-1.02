/* This was pulled from GDB for use in the linux kernel.  As linux
   is also covered by the GPL, there should be no problem. */

/* modified by Ross Biro bir7@leland.stanford.edu for use in
   the Linux Kernel debugger.  The only modifications that
   have been necessary are things to make gcc -WALL not
   complain */

/* Print i386 instructions for GDB, the GNU debugger.
   Copyright (C) 1988, 1989 Free Software Foundation, Inc.

This file is part of GDB. [And now also the Linux Kernel]
