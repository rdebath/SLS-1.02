...
#define VERSION "ELVIS 1.6, by Steve Kirkendall (27 April 1992)"
...
#endif
extern int	trapint P_((int));		/* trap handler for SIGINT */
extern int	deathtrap P_((int));		/* trap handler for deadly signals */
