 ...
 */
/*	$Header: set_emacs.c,v 4.3 88/06/23 09:40:47 bianchi Exp $
	$Source: /tmp/mgrsrc/demo/misc/RCS/set_emacs.c,v $
*/
static char	RCSid_[] = "$Source: /tmp/mgrsrc/demo/misc/RCS/set_emacs.c,v $$Revision: 4.3 $";

/* print the current termcap entry on stdout (for EMACS) */
