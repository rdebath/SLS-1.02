...
atld4:    subu $6,1             # count--
          bnez $6,atld3         # until (count==0)
        li $2,1                 # 1
        j $31                   # return
        .end addto_loop_down
...
sld1:     # kein Carry
          ...
          lw $12,($4)           # source1 = *sourceptr1
          lw $13,($5)           # source2 = *sourceptr2
          bltu $12,$13,sld4     # if (source1 < source2) [also Carry] ...
...
sld3:   # Hier Carry
          ...
          lw $12,($4)           # source1 = *sourceptr1
          lw $13,($5)           # source2 = *sourceptr2
          bgtu $12,$13,sld2     # if (source1 > source2) [also kein Carry] ...
...
sxld1:    # kein Carry
          ...
          lw $12,($4)           # source1 = *sourceptr1
          lw $13,($5)           # source2 = *sourceptr2
          bltu $12,$13,sxld5    # if (source1 < source2) [also Carry] ...
sxld2:    subu $12,$13          # dest = source1 - source2
          sw $12,($6)           # *destptr = dest
          subu $7,1             # count--
sxld3:    bnez $7,sxld1         # until (count==0)
        move $2,$0              # 0
        j $31                   # return
sxld4:  # Hier Carry
          subu $4,4             # sourceptr1--
          ...
          lw $12,($4)           # source1 = *sourceptr1
          lw $13,($5)           # source2 = *sourceptr2
          bgtu $12,$13,sxld2    # if (source1 > source2) [also kein Carry] ...
sxld5:    subu $12,$13          # dest = source1 - source2
          subu $12,1            #        - 1
          sw $12,($6)           # *destptr = dest
          subu $7,1             # count--
sxld6:    bnez $7,sxld4         # until (count==0)
        li $2,-1                # -1
        j $31                   # return
        .end subx_loop_down
...
sfld1:    # kein Carry
          ...
          lw $12,($4)           # source1 = *sourceptr
          lw $13,($5)           # source2 = *destptr
          bltu $12,$13,sfld4    # if (source1 < source2) [also Carry] ...
...
sfld3:  # Hier Carry
          ...
          lw $12,($4)           # source1 = *sourceptr
          lw $13,($5)           # source2 = *destptr
          bgtu $12,$13,sfld2    # if (source1 > source2) [also kein Carry] ...
