...
#define USG			/* identify as System V based */
...
#ifndef FOR_MAKE
/* I (SBB) don't know why this is here.  Every system that I know of
 * supports the signal call in the exact same way. */
