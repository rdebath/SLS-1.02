...
/* Define this to override the usage of "-lm" in ymakefile */
#define DEFAULT_LIBRARIES -lm -lseq
...
/* Pure BSD machines do not have memcpy.  Use "#ifndef memcpy" to decide to
 * include memory.h.
 */
# define memcpy(dest,src,len) (bcopy(src,dest,len))

/* Make sure to use bcopy instead of memcpy */
#define USE_BCOPY 1
