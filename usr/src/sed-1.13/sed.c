...
char *version_string = "GNU sed version 1.13";
     ...
     struct vector *vector;
{
  ...
  for (;;)
      ...
      if (compile_address (&(cur_cmd->a1)))
	{
      ...
      if (cur_cmd->a1.addr_type == ADDR_NUM
	  && cur_cmd->a2.addr_type == ADDR_NUM
	  && cur_cmd->a2.addr_number < cur_cmd->a1.addr_number)
	cur_cmd->a2.addr_number = cur_cmd->a1.addr_number + 1;
