/* $Header: /home/x_cvs/mit/server/ddx/x386/vga256/cfb.banked/cfbgc.c,v 1.7 1992/08/29 11:12:51 dawes Exp $ */
/***********************************************************
...
extern void speedupcfbLineSS(), speedupcfbSegmentSS();
extern void stdcfbLineSS(), stdcfbSegmentSS();
extern void speedupcfbTEGlyphBlt8(), stdcfbTEGlyphBlt8();
extern void (*ourcfbLineSS)(), (*ourcfbSegmentSS)(), (*ourcfbTEGlyphBlt8)();
    ...
    DrawablePtr	    pDrawable;
{
	...
	case LineSolid:
		...
		if (pGC->fillStyle == FillSolid)
		{
		    pGC->ops->Polylines = ourcfbLineSS;
		    pGC->ops->PolySegment = ourcfbSegmentSS;
		}
 		else
    ...
    if (new_text && (pGC->font))
    {
	    ...
	    {
#if PPW == 4
                pGC->ops->ImageGlyphBlt = ourcfbTEGlyphBlt8;
#else
