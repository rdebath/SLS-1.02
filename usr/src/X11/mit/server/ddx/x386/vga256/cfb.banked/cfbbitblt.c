/* $Header: /home/x_cvs/mit/server/ddx/x386/vga256/cfb.banked/cfbbitblt.c,v 1.7 1992/08/29 11:12:39 dawes Exp $ */
/*
 * cfb copy area
 */
    ...
    int dstx, dsty;
{
    ...
    localDoBitBlt = doBitBlt ? doBitBlt : ourcfbDoBitbltCopy;
    localBitBltPlane = bitBltPlane;
    doBitBlt = ourcfbDoBitbltCopy;
    bitBltPlane = 0;
    ...
    if (localDoBitBlt == ourcfbDoBitbltCopy)
    {
