/* $Header: /home/x_cvs/mit/server/ddx/x386/vga256/cfb.banked/cfbbstore.c,v 1.4 1992/08/29 11:12:45 dawes Exp $ */
/*-
 * cfbbstore.c --
    ...
    int	    	  	yorg;	    	/* Y origin of region */
{
    ...
    (*ourcfbDoBitbltCopy)((DrawablePtr)pPixmap->drawable.pScreen->devPrivate,
		(DrawablePtr)pPixmap,
		GXcopy,
		prgnSave,
		pPtsInit, ~0L);
    ...
    int	    	  	yorg;	    	/* Y origin of window */
{
    ...
    (*ourcfbDoBitbltCopy)((DrawablePtr)pPixmap,
