/* $Header: /home/x_cvs/mit/server/ddx/x386/vga256/cfb.banked/cfbwindow.c,v 1.4 1992/08/29 11:13:15 dawes Exp $ */
/***********************************************************
    ...
    RegionPtr prgnSrc;
{
    ...
    (*ourcfbDoBitbltCopy)((DrawablePtr)pwinRoot, (DrawablePtr)pwinRoot,
