/* $Header: /home/x_cvs/mit/server/ddx/x386/vga256/cfb.banked/cfbfillrct.c,v 1.6 1992/08/29 11:12:48 dawes Exp $ */
/*
 * Fill rectangles.
 */
    ...
    xRectangle	*prectInit;  	/* Pointer to first rectangle to fill */
{
	...
	switch (priv->rop) {
	case GXcopy:
	    BoxFill = ourcfbFillRectSolidCopy;
	    break;
	case GXxor:
	...
	if (!((cfbPrivGCPtr) pGC->devPrivates[cfbGCPrivateIndex].ptr)->
	    ...
	    BoxFill = ourcfb8FillRectTransparentStippled32;
	break;
	...
	if (!((cfbPrivGCPtr) pGC->devPrivates[cfbGCPrivateIndex].ptr)->
	    ...
	    BoxFill = ourcfb8FillRectOpaqueStippled32;
	break;
#endif
    }
    prect = prectInit;
