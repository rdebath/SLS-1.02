...
#ifdef SPEEDUP
void (*ourcfb8FillRectOpaqueStippled32)();
void (*ourcfb8FillRectTransparentStippled32)();
#endif
...
#else
stdcfb8FillRectOpaqueStippled32 (pDrawable, pGC, nBox, pBox)
#endif
...
#else
stdcfb8FillRectTransparentStippled32 (pDrawable, pGC, nBox, pBox)
#endif
    DrawablePtr	    pDrawable;
    GCPtr	    pGC;
    int		    nBox;	/* number of boxes to fill */
