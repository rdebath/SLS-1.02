/* $Header: /home/x_cvs/mit/server/ddx/x386/vga256/cfb.banked/cfbteblt8.c,v 1.10 1992/08/29 11:13:09 dawes Exp $ */
/*
...
#else
#define CFBTEGBLT8 stdcfbTEGlyphBlt8
#endif
#endif
...
#else
#define StorePixels(o,p)    *dst++ = (p); CHECKRWO(dst);
/* *dst++ = (p); CHECKRWO(dst); */
