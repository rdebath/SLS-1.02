/* $Header: /home/x_cvs/mit/server/ddx/x386/vga256/cfb.banked/cfbline.c,v 1.14 1992/08/29 11:12:57 dawes Exp $ */
/***********************************************************
...
#ifdef SPEEDUP
void (*ourcfbLineSS)(), (*ourcfbSegmentSS)();
#endif
...
#else
stdcfbSegmentSS (pDrawable, pGC, nseg, pSeg)
#endif
...
#else
stdcfbLineSS (pDrawable, pGC, mode, npt, pptInit)
#endif
    DrawablePtr pDrawable;
    GCPtr	pGC;
