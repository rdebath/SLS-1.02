/* $Header: /home/x_cvs/mit/server/ddx/x386/vga256/cfb.banked/cfbbltC.c,v 1.5 1992/09/07 13:18:33 dawes Exp $ */
/*
 * tfb copy area
 */
...
stdcfbDoBitbltCopy(pSrc, pDst, alu, prgnDst, pptSrc, planemask)
