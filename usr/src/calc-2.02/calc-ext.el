...
(defun calc-init-prefixes ()
  (if calc-shift-prefix
      (progn
	(aset calc-mode-map ?A (aref calc-mode-map ?a))
	(aset calc-mode-map ?B (aref calc-mode-map ?b))
	(aset calc-mode-map ?C (aref calc-mode-map ?c))
	(aset calc-mode-map ?D (aref calc-mode-map ?d))
	(aset calc-mode-map ?F (aref calc-mode-map ?f))
	(aset calc-mode-map ?G (aref calc-mode-map ?g))
	(aset calc-mode-map ?J (aref calc-mode-map ?j))
	(aset calc-mode-map ?K (aref calc-mode-map ?k))
	(aset calc-mode-map ?M (aref calc-mode-map ?m))
	(aset calc-mode-map ?S (aref calc-mode-map ?s))
	(aset calc-mode-map ?T (aref calc-mode-map ?t))
	(aset calc-mode-map ?U (aref calc-mode-map ?u)))
...
(defun calc-user-key-map ()
  (let ((res (cdr (elt calc-mode-map ?z))))
