...
\secno=0 \subsecno=0 \subsubsecno=0
%
% If we just use `#1' in the message, it is fully expanded -- and so if
% it contains @-commands, they will be expanded, and this is not at all
% what we want.  TeX expands \the\toks only once.
