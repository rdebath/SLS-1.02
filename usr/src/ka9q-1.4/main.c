...
static struct cmds startcmds[] = {
	...
	"telserv",	telserv1,	0, NULLCHAR, NULLCHAR,
#endif
	"remote",	rem1,		0, NULLCHAR, NULLCHAR,
	NULLCHAR,	NULLFP,		0,
#ifdef UNIX
#ifdef _FINGER
		"start options: discard, echo, finger, ftp, remote, smtp, telnet, telunix, x, telserv", NULLCHAR,
#else
		"start options: discard, echo, ftp, remote, smtp, telnet, telunix, x, telserv", NULLCHAR,
#endif
#else /* UNIX */
#ifdef _FINGER
...
static struct cmds stopcmds[] = {
	...
	"telserv",	telserv0,	0, NULLCHAR, NULLCHAR,
#endif
	"remote",	rem0,		0, NULLCHAR, NULLCHAR,
	NULLCHAR,	NULLFP,		0,
#ifdef UNIX
#ifdef _FINGER
		"stop options: discard, echo, finger, ftp, remote, smtp, telnet, telunix, x, telserv", NULLCHAR,
#else
		"stop options: discard, echo, ftp, remote, smtp, telnet, telunix, x, telserv", NULLCHAR,
#endif
#else /* UNIX */
#ifdef _FINGER
