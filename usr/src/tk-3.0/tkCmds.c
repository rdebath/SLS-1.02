...
#ifndef lint
static char rcsid[] = "$Header: /user6/ouster/wish/RCS/tkCmds.c,v 1.41 92/12/16 11:57:51 ouster Exp $ SPRITE (Berkeley)";
#endif /* not lint */
...
#define SETUP(name) \
	...
	Tcl_AppendResult(interp, "bad option \"", argv[1],
		"\": must be atom, atomname, children, class, ",
		...
		"screenwidth, toplevel, vrootheight, vrootwidth, ",
