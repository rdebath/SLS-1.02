...
#ifndef lint
static char rcsid[] = "$Header: /user6/ouster/tcl/RCS/tclCmdAH.c,v 1.78 92/08/25 20:47:36 ouster Exp $ SPRITE (Berkeley)";
#endif
    ...
    char **argv;			/* Argument strings. */
{
	...
	*newPtr = 0;
	...
	if (noPercent) {
		...
		sprintf(dst+dstSize, newFormat, (short) oneWordValue);
	    } else {
