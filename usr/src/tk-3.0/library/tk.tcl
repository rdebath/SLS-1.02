...
#
# $Header: /user6/ouster/wish/library/RCS/tk.tcl,v 1.25 92/12/16 17:11:43 ouster Exp $ SPRITE (Berkeley)
#
...
if "[info tclversion] != {6.5}" {
    error "wrong version of Tcl loaded ([info tclversion]): need 6.5"
}
if {$tk_version != 3.0} {
    error "wrong version of Tk loaded: need 3.0"
}
