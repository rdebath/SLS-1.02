...
int ch;
{
	...
	ch = 0x90 | (15 - ((ch - 2016) >> 7));
    else if(ch < 8160)
	ch = 0x80 | (15 - ((ch - 4064) >> 8));
    else
	ch = 0x80;
...
#else /* the sparc has a fixed frequency of 80000 Hz */
	step_table[i] = (int) (((3575872.0 / 8000.0) / i) * 65536.0);
#endif
