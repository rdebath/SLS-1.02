...
;       ...which is when final decay begins.  Instrument 1 gets turned
;       off at time 9 by the negative P2 of the penultimate card in the
;       score.  All other instruments get turned of by the e-card.
;       (This whole kluge is made necessary by the fact that the mtu
;       version of csound doesn't allow the ihold and turnoff statements
;       in the orchestra.)
...
i -1       9                            ;allow for a 4-beat final decay.
;i -1.1     9
;i -1.2     9
;i -1.3     9
;i -1.4     9
