...
/*
 * Stencil component declarations.
 */

#ifndef unidraw_components_stencilcomp_h
#define unidraw_components_stencilcomp_h
...
class StencilView : public GraphicView {
public:
...
class PSStencil : public PostScriptView {
public:
