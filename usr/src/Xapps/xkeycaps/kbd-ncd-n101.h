 ...
 *
 * This file describes the NCD X terminal N101 keyboard.
 *
 * Since I don't have access to an NCD-N101 keyboard, the default state
 * of the modifier bits (Option = Control, Alt = Mod1, Numlock = Mod5) is
 * a guess.  Let me know if it's wrong.
 */


static struct key NCD_N101_row0 [] = {
...
static struct key NCD_N101_row2 [] = {
...
static struct key NCD_N101_row3 [] = {
 ...
 {0x5C,	"|",	"\\",	12, 7,	0,	XK_backslash, XK_bar},
 {0,	0,	0,	4, 7},
...
static struct key NCD_N101_row4 [] = {
 {0x14,"Ctrl",	0,	13, 7,	ControlMask, 	XK_Control_L},
 {0x1C,	"A",	0,	7, 7,	0,		XK_A},
 {0x1B,	"S",	0,	7, 7,	0,		XK_S},
 {0x23,	"D",	0,	7, 7,	0,		XK_D},
 {0x2B,	"F",	0,	7, 7,	0,		XK_F},
 ...
 {0x5A,"Return", 0,	16, 7,	0,		XK_Return},
 {0,	0,	0,	29, 7},
...
static struct key NCD_N101_row5 [] = {
...
static struct key NCD_N101_row6 [] = {
 {0x11, "Caps","Lock",	11, 7,	LockMask,	XK_Caps_Lock},
 {0,	0,	0,	7, 7},
 {0x19,"Alt",	0,	11, 7,	Mod1Mask,	XK_Alt_L},
 {0x29,	" ",	0,	48, 7,	0, 		XK_space},
 {0x39,"Alt",	0,	11, 7,	Mod1Mask, 	XK_Alt_R},
 {0,	0,	0,	7, 7},
 {0x58,"Option", 0,	11, 7,	ControlMask,	XK_Control_R},
 {0,	0,	0,	4, 7},
...
static struct row NCD_N101_rows [] = {
  { sizeof (NCD_N101_row0) / sizeof (struct key), 7, NCD_N101_row0 },
  { 0, 5, 0 },
  { sizeof (NCD_N101_row2) / sizeof (struct key), 7, NCD_N101_row2 },
  { sizeof (NCD_N101_row3) / sizeof (struct key), 7, NCD_N101_row3 },
  { sizeof (NCD_N101_row4) / sizeof (struct key), 7, NCD_N101_row4 },
  { sizeof (NCD_N101_row5) / sizeof (struct key), 7, NCD_N101_row5 },
  { sizeof (NCD_N101_row6) / sizeof (struct key), 7, NCD_N101_row6 }
};

static struct keyboard NCD_N101 = {
  "N101", "Network Computing Devices N101",
  sizeof (NCD_N101_rows) / sizeof (struct row),
  NCD_N101_rows,
  6, 3, 3
};
