 ...
 *
 * This file describes the NCD X terminal N102 keyboard.
 * By Pekka Nikander <pnr@innopoli.ajk.tele.fi>
 */

static struct key NCD_N102_row0 [] = {
...
static struct key NCD_N102_row2 [] = {
...
static struct key NCD_N102_row3 [] = {
...
static struct key NCD_N102_row4 [] = {
...
static struct key NCD_N102_row5 [] = {
 {0x12,"Shift",	0,	9, 7,	ShiftMask,	XK_Shift_L},
 {0x13,	"|",	"\\",	7, 7,	0,		XK_backslash,	XK_bar},
 {0x1A,	"Z",	0,	7, 7,	0,		XK_Z},
 {0x22,	"X",	0,	7, 7,	0,		XK_X},
 {0x21,	"C",	0,	7, 7,	0,		XK_C},
 {0x2A,	"V",	0,	7, 7,	0,		XK_V},
...
static struct key NCD_N102_row6 [] = {
...
static struct row NCD_N102_rows [] = {
  { sizeof (NCD_N102_row0) / sizeof (struct key), 7, NCD_N102_row0 },
  { 0,	5, 0 },
  { sizeof (NCD_N102_row2) / sizeof (struct key), 7, NCD_N102_row2 },
  { sizeof (NCD_N102_row3) / sizeof (struct key), 7, NCD_N102_row3 },
  { sizeof (NCD_N102_row4) / sizeof (struct key), 7, NCD_N102_row4 },
  { sizeof (NCD_N102_row5) / sizeof (struct key), 7, NCD_N102_row5 },
  { sizeof (NCD_N102_row6) / sizeof (struct key), 7, NCD_N102_row6 }
};

static struct keyboard NCD_N102 = {
  "N102", "Network Computing Devices N102",
  sizeof (NCD_N102_rows) / sizeof (struct row),
  NCD_N102_rows,
  6, 3, 3
};
