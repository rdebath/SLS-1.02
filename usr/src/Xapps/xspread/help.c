...
" ",
"     ALSO:      See 'Using the mouse' for moving on the xspread work-",
"		 sheet",
0
};
...
" O: Using the mouse",
" ",
"       While in the spreadsheet work area:",
"         1) Move the mouse pointer to a cell and press button 1 or 2.",
"         2) 'click' on the left, right, bottom edges to move the work-",
"            sheet area in that direction.  To move the worksheet up one",
"            'click' in the column labels area.",
"         3) To enter into the menu 'click' button number three (3).",
" ",
"       While inside the menu system:",
"         1) Move the mouse pointer ontop of the option you wish to use.",
"         2) 'click' with the button to enter the desired option.",
"         3) 'click' outside of the menu area to bounce back one.",
0
};
...
" P: Matrix Operations",
" ",
"       1) Enter '/' at the xspread worksheet area.",
"       2) Select the 'MATH' menu.",
"       3) There the user has 5 options available: Transpose, ",
"          Add, Subtract, Multiply, or Invert a Matrix.",
" ",
"       Transpose:   Transpose a specified matrix.",
"       Addition:    Add two matrixs together.",
"       Subtraction: Subtract two matrixs.",
"       Multiply:    Multiply two matrixes together.",
"       Invert:      Invert a specified matrix",
0
};
...
" ",
"       1) Enter '/' at the xspread worksheet area.",
"       2) Select the 'Graph' menu.",
" ",
"       There are 5 types of graphs available in xspread: Line,",
"       Bar, XY, Stack Bar, and Pie graph.",
" ",
" ",
"       Line:      Conects lines dot to dot comparing Y to X labels.",
"       Bar:       Shows Y data in the form of verticle bars.",
"       Stack Bar: Shows the related Y data Y1, Y2, Y3,... stack on top of",
"                  each other.",
"       Pie:       Relates Y data to X via a pie graph",
0
};
...
help()
{
	...
	case 'o': case 'O': ns = mousef; break;
	case 'p': case 'P': ns = matrixf; break;
	case 'r': case 'R': ns = graphf; break;
