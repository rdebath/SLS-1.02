#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)frame_init.c 1.41 91/09/14";
#endif
#endif
    ...
    Attr_avlist	    avlist;
{
...
#ifdef OW_I18N
    frame->leftfooter_wcs = (wchar_t *)NULL;
    frame->rightfooter_wcs = (wchar_t *)NULL;
#endif
    ...
    frame->leftIMstatus = (char *)NULL;
    frame->rightIMstatus = (char *)NULL;
    frame->leftIMstatus_wcs = (wchar_t *)NULL;
    frame->rightIMstatus_wcs = (wchar_t *)NULL;
#endif
	...
	XChangeProperty(xv_display(info), xv_xid(info), xv_get(xv_server(info),
			SERVER_ATOM, "_XVIEW_V2_APP"), XA_INTEGER,
