#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)curs_cmpat.c 20.22 91/09/14";
#endif
#endif
    ...
    register Xv_Cursor cursor_public;
{
    ...
    if( cursor_create_internal( (Xv_object) xv_get( cursor_public, XV_OWNER),
          object, XV_COPY_OF, cursor_public, NULL ) == XV_OK )
       return object;
    else
       return XV_NULL;
}
