/*      @(#)windowimpl.h 20.72 91/09/14 SMI      */
...
typedef struct window_info {
    ...
    unsigned		 win_ic_conversion:1;          /* is IC conversion on */
    ...
    XIMCallback          start_luc_struct;     /* lookup choice done callback */
    XIMCallback          draw_luc_struct;      /* lookup choice draw callback */   
    XIMCallback          process_luc_struct; /*lookup choice process callback */
    XIMCallback          done_luc_struct;      /* lookup choice done callback */
    XIMCallback          start_aux_struct; /* auxiliary region start callback */
    XIMCallback          draw_aux_struct;   /* auxiliary region draw callback */
    XIMCallback          done_aux_struct;   /* auxiliary region done callback */
#endif
