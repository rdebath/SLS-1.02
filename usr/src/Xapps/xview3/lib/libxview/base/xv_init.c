#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)xv_init.c 20.61 91/10/04";
#endif
#endif
...
#ifndef XGETTEXT
Xv_private_data const char		*xv_domain = "xv_messages";
#endif
...
#endif
{
    ...
    /* DND_HACK begin */
    xv_set_interest_property = False;
    /* DND_HACK end */
	...
	switch ((Xv_attr) attrs[0]) {
	  /* DND_HACK begin */
	  case XV_INIT_ARGS_FOR_DND:
	  case XV_INIT_ARGS_NAV:
	  /* DND_HACK end */
	  case XV_INIT_ARGS:
	    argc = (int) attrs[1];
	    argv = (char **) attrs[2];
	  ...
	  /* DND_HACK begin */
	  case XV_INIT_ARGC_PTR_ARGV_FOR_DND:
	  case XV_INIT_ARGC_PTR_ARGV_NAV:
	  /* DND_HACK end */
