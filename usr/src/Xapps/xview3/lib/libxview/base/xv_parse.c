#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)xv_parse.c 20.50 91/09/14";
#endif
#endif
...
static Cmd_line_flag cmd_line_flags[] = {
    ...
    "-name", "-name", 0, 0, 1,
    "-lc_basiclocale", "-lc_basiclocale", "basicLocale", 0, 1,
    "-lc_displaylang", "-lc_displaylang", "displayLang", 0, 1,
    "-lc_inputlang", "-lc_inputlang", "inputLang", 0, 1,
    "-lc_numeric", "-lc_numeric", "numeric", 0, 1,
    "-lc_timeformat", "-lc_timeformat", "timeFormat", 0, 1,
#ifdef _XV_DEBUG
    "", "-list_fonts", 0, 0, 0,
    "", "-Xv_debug", 0, 0, 1,
    "", "-stats", 0, 0, 0,
