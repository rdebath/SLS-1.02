...
typedef struct panel_info {
    ...
    Item_info		 *pre_edit_item;/* panel item with the keyboard focus */
    ...
    XIMPreeditDrawCallbackStruct  *pre_edit; /*Save full pre_edit information*/
#endif
} Panel_info;
...
Pkg_private void	        panel_text_start();
Pkg_private void	        panel_text_draw();
Pkg_private void	        panel_text_done();
Pkg_private void	        pre_edit_display();
Pkg_private 			ml_panel_display_interm();
Pkg_private 			ml_panel_saved_caret();
Pkg_private 			ml_panel_simple_display();
Pkg_private 			panel_implicit_commit();
#endif /* OW_I18N */
