#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)tty_menu.c 20.62 91/09/14";
#endif
#endif
...
#ifdef OW_I18N
	ttysw_implicit_commit(ttysw_folio);
#endif
    ...
    Menu_item       cmd_item;
{
    ...
    Xv_Notice	tty_notice;
#ifdef OW_I18N
    Textsw_view_handle	text_view_handle;
#endif

    if (ttysw_getopt(ttysw_folio, TTYOPT_TEXT)) {
#ifdef OW_I18N
	text_view_handle =
		VIEW_FROM_FOLIO_OR_VIEW((Textsw_folio)TEXTSW_PRIVATE(textsw));
	textsw_implicit_commit(text_view_handle);
#endif
