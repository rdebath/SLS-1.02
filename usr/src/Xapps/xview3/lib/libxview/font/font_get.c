#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)font_get.c 20.24 91/09/14";
#endif
#endif
    ...
    va_list         args;
{
    ...
    register Pixfont *pf = (Pixfont *) (font->pixfont);
#ifdef OW_I18N
    XFontStruct         *font_struct = (XFontStruct *)font->font_structs[0];
#else
