#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)pf_text.c 20.28 91/09/14 SMI";
#endif
#endif
    ...
    char           *str;
{
	 ...
	 */
	server_image_pf_text(prpos, op, pf, str);
	return;
    }
    /*
    ...
    register wchar_t  	*ws;
{
    ...
    size.x = overall_logical_extents.width;
    size.y = overall_logical_extents.height;	/* max height so won't clip */    return (size);
}
#endif /*OW_I18N*/
