/*      @(#)svr_kmdata.h  1.14  91/09/14  SMI   */
...
static Key_binding sunview1_kbd_cmds[] = {
    ...
    ACTION_GO_PAGE_BACKWARD, "OpenWindows.KeyboardCommand.GoPageBackward", "R9",
    ACTION_GO_PAGE_FORWARD, "OpenWindows.KeyboardCommand.GoPageForward", "R15",
...
static Key_binding basic_kbd_cmds[] = {
    ...
    ACTION_PANE_UP, "OpenWindows.KeyboardCommand.PaneUp", "R9",
    ACTION_PANE_DOWN, "OpenWindows.KeyboardCommand.PaneDown", "R15",
    ACTION_PANE_LEFT, "OpenWindows.KeyboardCommand.PaneLeft", "R9+Ctrl",
    ACTION_PANE_RIGHT, "OpenWindows.KeyboardCommand.PaneRight", "R15+Ctrl",
    ACTION_DATA_START, "OpenWindows.KeyboardCommand.DataStart",
	"Home+Ctrl,R7+Ctrl",
