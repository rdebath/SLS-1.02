 ...
 * OPEN LOOK geometry
 */
Pkg_private int		notice_border_width;
Pkg_private int		pane_border_width;
Pkg_private int		pane_notice_border_dist;
Pkg_private int		pane_xy; 
Pkg_private int		pane_notice_diff;
Pkg_private int		l_margin;
Pkg_private int		r_margin;
Pkg_private int		msg_top_margin;
Pkg_private int		msg_bot_margin;
Pkg_private int		but_portion_height;
Pkg_private int		msg_vert_gap;
Pkg_private int		but_horiz_gap;
