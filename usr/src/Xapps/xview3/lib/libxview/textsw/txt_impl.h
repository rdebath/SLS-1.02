...
#ifdef OW_I18N		/* Tune off undo for intermediate region */
...
#ifdef OW_I18N
	CHAR		 *temp_filename_wc; /* For cmdsw log */
#endif
...
#ifdef OW_I18N
	XIC		  ic;
	Ev_mark_object	  temp_mark;
	/*
	 * insertion point for intermediate text.
	 * When temp_mark is non NULL, IC exists, conversion mode is ON
	 * and intermediate text exists.
	 */
	int		  pecb_first_time;
